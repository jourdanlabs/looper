// LOOPER — RICE scoring with a 3-year NPV Impact (the methodology, §3.1/§4).
//
...
//   Reach       = customers/items/engineers affected per year
//
...
// the numbers are legible. The knee is chosen so a strong initiative lands
...
export function scoreInitiative(it, opts = {}) {
  ...
  // sub-linearly (sqrt) so a 5M-customer item doesn't bury a 50k-item item that
  // has 100× the per-unit NPV. "Reach" is a multiplier, not the story.
