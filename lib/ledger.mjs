...
/** Canonical ledger event kinds — one chain under all LOOPER modules. */
export const LEDGER_KINDS = Object.freeze({
  ...
  PPO_APPROVED: "PPO_APPROVED",
  ACCESS_GRANTED: "ACCESS_GRANTED",
  PAT_CONTEXT_UPDATED: "PAT_CONTEXT_UPDATED",
  PAT_CONTEXT_REMOVED: "PAT_CONTEXT_REMOVED",
